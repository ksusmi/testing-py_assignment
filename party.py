...
def is_mel(name, email):
    ...
    >>> is_mel('Judit Butler', 'mel@ubermelon.com')
    True
...
def most_and_least_common_type(treats):
    ...
    >>> most_and_least_common_type([{'type': 'dessert'},{'type': 'drink'},{'type': 'dessert'},{'type': 'appetizer'},{'type': 'drink'},{'type': 'dessert'}])
    ('dessert', 'appetizer')

    >>> most_and_least_common_type([{'type': 'dessert'},{'type': 'drink'},{'type': 'dessert'},{'type': 'appetizer'},{'type': 'drink'}])
    ('dessert', 'appetizer')

    >>> most_and_least_common_type([{'type': 'drink'},{'type': 'dessert'},{'type': 'dessert'},{'type': 'appetizer'},{'type': 'drink'}])
    ('drink', 'appetizer')

    >>> most_and_least_common_type([{'type': 'dessert'},{'type': 'drink'},{'type': 'appetizer'}])
    ('dessert', 'dessert')
